...
<head>
    ...
    function changOut(){
    	var t = 0;
    	var size = document.getElementsByName('radio-1');

    	if (size) {

    		for (var i = 0; i < size.length; i++) {
    			if (size[i].checked) {
    				t = t + parseInt(size[i].value);
    			};
    		};
    	};

    	var priority = document.getElementsByName('radio-2');

    	if (priority) {

    		for (var i = 0; i < priority.length; i++) {
    			if (priority[i].checked) {
    				t = t + parseInt(priority[i].value);
    			};
    		};
    	};
					...
					{{ csrf_field() }}
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-9">
									...
									<table class="table responsive">
										...
										<tr>
											<td><strong>Priority of AD</strong></td>
							...
							<div class="col-sm-9">
								<p>
									<label class="radio-inline">
										<input type="radio" name="radio-1" checked value="10" onclick="changOut()">
										Basic: $10
									</label>
									<label class="radio-inline">
										<input type="radio" name="radio-1" value="20" onclick="changOut()">
										Medium: $20
									</label>
									<label class="radio-inline">
										<input type="radio" name="radio-1" value="30" onclick="changOut()">
										Large: $30
									</label>
								</p>
							</div>
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-9">
								<p>
									<label class="radio-inline">
										<input type="radio" name="radio-2" value="10" checked onclick="changOut()">
										None: $10
									</label>
									<label class="radio-inline">
										<input type="radio" name="radio-2" value="20" onclick="changOut()">
										Medium: $20
									</label>
									<label class="radio-inline">
										<input type="radio" name="radio-2" value="30" onclick="changOut()">
										Forward: $30
									</label>
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-9">
							<input type="text" style="border:none;" class="form-control" id="totalprice" name="amount" value="20" readonly>
							</div>
						</div>
