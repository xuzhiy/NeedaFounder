...
<div class="container">
<div class="row">
	<div class="col-sm-4 list_op"><a href="business" style="color: black"> Join a business </a></div>
...
<div class="row">
		...
		<div class="container-fluid"> 
			...
			<div class="navbar-header">
				<div class="collapse navbar-collapse" id="inverseNavbar1">
					<form action="job?search=1" method="post" class="navbar-form navbar-left" role="search">
						{{ csrf_field() }}
	...
	<div class="row">
		<div class="col-sm-4 picture all_center" style="height: 150px"><img src="img/job.png" alt="Job" height="150px" width="300px"></div>
		<div class="col-sm-4" style="height: 150px">
			<div class="jobtitle"><a href="jobDetail?id={{$data->id}}">{{$data->job}}</a></div>
