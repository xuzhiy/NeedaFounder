				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="changePass_enterprise" method="post" role="form" class="form-horizontal">
								{{ csrf_field() }}
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="changeInfor_enterprise" method="post" role="form" class="form-horizontal">
								{{ csrf_field() }}
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-1">Enterprise Name</label>
									
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-1" value="{{$enterprise_account->name}}" name="name">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-4" value="{{$enterprise_account->phone}}" name="phone">
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-5">Enterprise Email</label>
									
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-5" value="{{$enterprise_account->email}}" readonly name="email">
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="field-6">Enterprise Address</label>
									
									<div class="col-sm-10">
										<input type="text" class="form-control" id="field-6" value="{{$enterprise_account->address}}" name="address">
									</div>
								</div>
